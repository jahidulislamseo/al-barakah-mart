...
export function WhatsAppButton() {
    ...
    const phoneNumber = '8801609132361' // Bangladesh format with country code
    const message = 'Hello! I need help with Al Barakah Mart.'
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3 bg-[#25D366] text-white rounded-full shadow-2xl hover:shadow-[0_8px_30px_rgb(37,211,102,0.5)] transition-all duration-300 hover:scale-110 relative overflow-hidden">
                ...
                <span
                    className={`
                        font-semibold text-sm pr-5 relative z-10
